...
from pystrukts.classic_problems.greedy.activity_selector import Activity
from pystrukts.classic_problems.greedy.activity_selector import select_compatible_activities
